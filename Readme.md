...
│   │   │   ├── Journal.jsx            # Trade journaling page
│   │   │   ├── Analysis.jsx           # Deep analytics breakdown
│   │   │   ├── Market.jsx             # Market overview widgets
│   │   │   └── AIFeatures/
│   │   │       ├── AIHub.jsx          # Main AI features landing page
│   │   │       ├── EmotionDetector.jsx
│   │   │       ├── TradeCoach.jsx
│   │   │       ├── WeeklyReport.jsx
...
│   │   │   ├── emotionColors.js       # Color mapping for emotions
│   │   │   └── tradeHelpers.js
│   │   ├── styles/
│   │   │   └── globals.css
│   │   ├── App.jsx
...
│   │   │   └── ai.controller.js       # Routes to AI service
│   │   ├── routes/
│   │   │   ├── auth.routes.js
│   │   │   ├── trade.routes.js
│   │   │   ├── journal.routes.js
...
│   │   │   └── upload.middleware.js   # Multer for chart screenshots
│   │   ├── services/
│   │   │   ├── mt5SyncService.js      # MetaApi trade syncing logic
│   │   │   ├── pollService.js         # Background polling (every 5 min)
│   │   │   ├── encryptService.js      # AES-256 for MT5 credentials
│   │   │   └── aiProxyService.js      # Calls AI microservice
│   │   ├── utils/
│   │   │   ├── pairDeals.js           # Pair MT5 open/close deals into trades
│   │   │   ├── calcMetrics.js         # Win rate, profit factor, R:R etc.
│   │   │   └── dateHelpers.js
